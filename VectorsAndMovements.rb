class VectorsAndMovements
    ...
    def rotate(direction)
        ...
        #Global varible. Used for simplicty. Alternivately would reuqire too much passing. Some people may consider this smart others may not like the use of a global
