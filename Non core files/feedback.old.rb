class Feedback
	...
	def give_feedback(feedback_name)
		...
		"place_format_invalid" => "Sorry Sir the PLACE command direction format is invalid. One more time... Please follow the example format",
		"place_is_off_table" => "Nooooooo your placing me off the table!!! I won't do it! I won\'t! One more time.... Please PLACE me within the bounds of the table",   
